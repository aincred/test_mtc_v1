...
// //   // Mobile View State for 30-Day Routine Grid
...
// //         const foundChildRaw = dbChildren.find(
// //           (c) => c.registration_id?.toString() === childId || c.id === childId
// //         );
...
// //         // 2. Fetch Micronutrients Data from DB
// //         const dataRes = await fetch(`/api/micronutrients?childId=${childId}`);
// //         const dbResult = (await dataRes.json()) as {
// //           success: boolean;
// //           data?: { routine_data: TreatmentEntry[]; lab_data: LabTestEntry[] };
// //         };
...
// //           <p className="text-slate-500 font-medium text-sm sm:text-base">Loading clinical records...</p>
// //         </div>
// //       </div>
// //     );
// //   }
...
// //             <Button
// //               onClick={() => router.push("/mtc-user/dashboard/micronutrients")}
// //               variant="ghost"
// //               size="icon"
// //               className="text-slate-500 hover:text-emerald-600 hover:bg-emerald-50 shrink-0 h-9 w-9 sm:h-10 sm:w-10"
// //             >
// //               <ArrowLeft className="h-5 w-5" />
// //             </Button>
// //             <div>
// //               <h1 className="text-base sm:text-lg font-bold text-slate-900 leading-tight truncate max-w-50 xs:max-w-xs sm:max-w-none">
// //                 Antibiotics & Micronutrients
// //               </h1>
// //               <p className="text-[11px] sm:text-xs font-medium text-slate-500">Treatment Flowsheet</p>
// //             </div>
// //           </div>
// //         </div>
// //       </div>

// //       <main className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 mt-4 sm:mt-8 space-y-4 sm:space-y-6">
// //         {/* Child Information Header Card */}
// //         <div className="bg-white p-4 sm:p-6 rounded-xl sm:rounded-2xl border border-slate-200 shadow-sm flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
// //           <div className="flex items-center gap-3 sm:gap-4 w-full sm:w-auto">
// //             <div className="h-10 w-10 sm:h-12 sm:w-12 rounded-full bg-emerald-100 text-emerald-700 flex items-center justify-center font-bold text-lg sm:text-xl border-2 border-emerald-200 shrink-0">
// //               {child.childName.charAt(0)}
// //             </div>
// //             <div className="min-w-0 flex-1">
// //               <h2 className="text-base sm:text-lg font-bold text-slate-900 truncate">{child.childName}</h2>
// //               <p className="text-xs sm:text-sm text-slate-500 font-medium truncate">Guardian: {child.parentName}</p>
// //             </div>
// //           </div>
// //           <div className="w-full sm:w-auto px-3 py-1.5 sm:px-4 sm:py-2 bg-slate-50 rounded-lg sm:rounded-xl border border-slate-100 text-left sm:text-right flex sm:block justify-between items-center">
// //             <span className="text-[10px] font-bold text-slate-400 uppercase block sm:mb-0.5">SAM Number</span>
// //             <span className="text-xs sm:text-sm font-mono font-bold text-emerald-700">{child.samNumber}</span>
// //           </div>
// //         </div>

// //         {/* Routine Treatment Section */}
// //         <Card className="border-0 shadow-sm sm:shadow-[0_2px_10px_-3px_rgba(6,81,237,0.1)] overflow-hidden">
// //           <CardContent className="p-4 sm:p-6 lg:p-8">
// //             <SectionTitle icon={Pill} title="Routine Treatments (30-Day Grid)" />

// //             {/* --- MOBILE VIEW: Day Navigation & Cards (< lg Screens) --- */}
...
// //                   variant="ghost"
// //                   size="sm"
// //                   onClick={() => setActiveMobileDay((prev) => Math.max(0, prev - 1))}
...
// //                   <span>Day {activeMobileDay}</span>
// //                 </div>
// //                 <Button
// //                   variant="ghost"
// //                   size="sm"
// //                   onClick={() => setActiveMobileDay((prev) => Math.min(29, prev + 1))}
// //                   disabled={activeMobileDay === 29}
// //                   className="h-8 w-8 p-0"
// //                 >
...
// //               {/* Medication Checklist for Selected Day */}
// //               <div className="space-y-2 pt-2">
// //                 {routineTreatments.map((treatment, index) => {
// //                   const isIronSyrup = TREATMENT_NAMES[index] === "Iron Syrup (ml)";
// //                   const dayKey = `day${activeMobileDay}` as keyof TreatmentEntry;
// //                   const isChecked = treatment[dayKey] === 1;
// //                   const isDisabled = isIronSyrup && activeMobileDay <= 7;
...
// //                       }`}
// //                     >
// //                       <span className="text-xs sm:text-sm font-semibold text-slate-700 pr-2">
// //                         {TREATMENT_NAMES[index]}
// //                       </span>
// //                       <input
// //                         type="checkbox"
// //                         className="w-5 h-5 text-emerald-600 rounded border-slate-300 focus:ring-emerald-500/30 disabled:cursor-not-allowed cursor-pointer shrink-0"
// //                         checked={isChecked}
// //                         onChange={() => handleCheckboxChange(index, activeMobileDay)}
// //                         disabled={isDisabled}
// //                       />
// //                     </label>
// //                   );
...
// //                 <div className="pt-2">
// //                   <label className="text-xs font-bold text-slate-600 block mb-1">Other Medicine Details</label>
// //                   <Input
// //                     value={routineTreatments[10]?.otherRoutine || ""}
// //                     onChange={(e) => handleOtherMedicineChange(e.target.value)}
// //                     placeholder="Specify if 'Other Medicine' was administered..."
...
// //             {/* --- DESKTOP VIEW: Full 30-Day Matrix Table (≥ lg Screens) --- */}
// //             <div className="hidden lg:block overflow-x-auto rounded-xl border border-slate-200 custom-scrollbar">
// //               <table className="min-w-full text-sm text-slate-700 border-collapse">
// //                 <thead>
// //                   <tr className="bg-slate-50 border-b border-slate-200">
// //                     <th className="py-3 px-4 text-left font-bold text-slate-800 sticky left-0 bg-slate-50 z-10 border-r border-slate-200">
// //                       Medication
// //                     </th>
// //                     {Array.from({ length: 30 }, (_, i) => (
// //                       <th key={i} className="py-3 px-2 text-center font-bold text-slate-500 min-w-10">
...
// //                         <td className="py-3 px-4 font-semibold text-slate-700 sticky left-0 bg-white z-10 border-r border-slate-200 group-hover:bg-emerald-50/50">
// //                           {TREATMENT_NAMES[index]}
// //                         </td>
// //                         {Array.from({ length: 30 }, (_, dayIndex) => {
// //                           const dayKey = `day${dayIndex}` as keyof TreatmentEntry;
// //                           const isChecked = treatment[dayKey] === 1;
// //                           const isDisabled = isIronSyrup && dayIndex <= 7;

// //                           return (
// //                             <td
// //                               key={dayIndex}
// //                               className={`py-2 px-1 text-center ${isDisabled ? "bg-slate-100/70" : ""}`}
// //                             >
// //                               <input
// //                                 type="checkbox"
// //                                 className="w-4 h-4 text-emerald-600 rounded border-slate-300 focus:ring-emerald-500/30 disabled:opacity-30 disabled:cursor-not-allowed cursor-pointer"
// //                                 checked={isChecked}
// //                                 onChange={() => handleCheckboxChange(index, dayIndex)}
// //                                 disabled={isDisabled}
// //                                 title={isDisabled ? "Iron Syrup is locked for D0-D7" : undefined}
// //                               />
// //                             </td>
// //                           );
// //                         })}
...
// //         <Card className="border-0 shadow-sm sm:shadow-[0_2px_10px_-3px_rgba(6,81,237,0.1)]">
// //           <CardContent className="p-4 sm:p-6 lg:p-8">
// //             <SectionTitle icon={Activity} title="Laboratory Investigations" />

// //             {/* Responsive Container for Lab Tests */}
// //             <div className="space-y-3 md:space-y-0 md:border md:border-slate-200 md:rounded-xl md:overflow-hidden">
// //               {/* Desktop/Tablet Table Header */}
// //               <div className="hidden md:grid md:grid-cols-12 bg-slate-50 border-b border-slate-200 py-3 px-4 text-xs font-bold text-slate-800 uppercase tracking-wider">
// //                 <div className="col-span-5">Test Name</div>
// //                 <div className="col-span-3">Conducted?</div>
// //                 <div className="col-span-4">Result / Value</div>
// //               </div>
...
// //                   <div
// //                     key={index}
// //                     className="p-3 bg-white border border-slate-200 rounded-xl md:rounded-none md:border-0 md:p-0 md:grid md:grid-cols-12 md:items-center md:px-4 md:py-3 hover:bg-emerald-50/30 transition-colors"
// //                   >
// //                     <div className="font-semibold text-slate-800 text-xs sm:text-sm md:col-span-5 mb-2 md:mb-0">
// //                       {LAB_TEST_NAMES[index]}
// //                     </div>

// //                     {index < 7 ? (
// //                       <>
// //                         <div className="md:col-span-3 mb-2 md:mb-0 pr-0 md:pr-2">
// //                           <select
// //                             className="w-full h-9 sm:h-10 px-3 rounded-lg border border-slate-200 bg-white text-xs sm:text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500/30"
// //                             value={test.day0}
// //                             onChange={(e) => handleLabTestStatusChange(index, e.target.value)}
// //                           >
...
// //                               test.day0 !== 1 ? "bg-slate-100 opacity-60" : "bg-white"
// //                             }`}
// //                           />
// //                         </div>
// //                       </>
...
// //                           onChange={(e) => handleChestXRayChange(e.target.value)}
// //                           placeholder="Enter X-Ray details"
// //                           className="h-9 sm:h-10 bg-white text-xs sm:text-sm"
// //                         />
// //                       </div>
// //                     )}
// //                   </div>
...
// //       <div className="fixed bottom-0 left-0 right-0 bg-white/95 backdrop-blur-md border-t border-slate-200 py-3 sm:py-4 px-4 sm:px-6 z-40 shadow-lg">
// //         <div className="max-w-7xl mx-auto flex items-center justify-end gap-2 sm:gap-3">
// //           <Button
// //             type="button"
// //             variant="outline"
// //             onClick={() => router.push("/mtc-user/dashboard/micronutrients")}
// //             className="rounded-full border-slate-300 text-slate-700 hover:bg-slate-100 px-4 sm:px-6 py-2 text-xs sm:text-sm font-semibold shadow-sm h-9 sm:h-10"
// //           >
// //             <X className="mr-1.5 sm:mr-2 h-4 w-4" /> Cancel
// //           </Button>
...
// //             onClick={handleSave}
// //             disabled={saving}
// //             className="rounded-full bg-emerald-600 hover:bg-emerald-700 text-white px-5 sm:px-6 py-2 text-xs sm:text-sm font-semibold shadow-md transition-all duration-200 hover:shadow-lg h-9 sm:h-10"
// //           >
// //             {saving ? (
...
// Reordered so "Other Tests" is last and "Blood Sugar" is before it with Yes/No format
const LAB_TEST_NAMES = [
  "Haemoglobin (gm/dl)", "TB Test", "Urine Test",
  "TC/DC of WBC", "Chest X-ray", "Malaria Test", "Blood Sugar", "Other Tests (For repeated tests)" 
];

const SECTION_IDS = {
  routine: [5, 6, 7, 8, 2, 4, 9, 1, 3, 10, 19],
  // Updated lab section IDs to match the new reordered LAB_TEST_NAMES above
  lab: [11, 13, 14, 15, 16, 12, 17, 18]
};
...
export default function EditMicronutrientsPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const handleOtherTestChange = (value: string) => {
    setLabTests(prev => {
      const updated = [...prev];
      updated[7] = { ...updated[7], others: value }; // Index 7 is now "Other Tests"
      return updated;
    });
  };
    ...
    <div className="min-h-screen bg-slate-50 pb-28 font-sans">
      ...
      <div className="bg-white border-b border-slate-200 sticky top-0 z-30 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          ...
          {/* Action buttons removed from here as per instructions */}
        </div>
      </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 mt-8 space-y-6">
                    ...
                    <tr key={index} className="hover:bg-blue-50/50 transition-colors">
                      ...
                      {index < 7 ? (
                        ...
                        <td colSpan={2} className="py-3 px-4">
                          <Input
                            value={test.others || ""}
                            onChange={(e) => handleOtherTestChange(e.target.value)}
                            placeholder="Enter Other Test Details..."
                            className="bg-white"
                          />
                        </td>
                      )}
        ...
        <div className="flex items-center justify-end gap-3 mt-8">
          <Button variant="outline" onClick={() => router.push("/mtc-user/dashboard/micronutrients")} className="border-slate-200 text-slate-600 px-6">
            <X className="mr-2 h-4 w-4" /> Cancel
          </Button>
          <Button onClick={handleSave} disabled={saving} className="bg-green-600 hover:bg-green-700 text-white shadow-sm px-8">
            {saving ? <Loader2 className="h-4 w-4 mr-2 animate-spin" /> : <Save className="mr-2 h-4 w-4" />}
            {saving ? "Saving..." : "Save Changes"}
          </Button>
        </div>
