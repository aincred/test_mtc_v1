...
import React, { useState, useEffect } from "react";
import { useRouter, useParams } from "next/navigation";
import { Clock, Landmark, ClipboardCheck, MapPin, Activity, Stethoscope, Baby, ShieldCheck, ArrowLeft, Loader2, Lock } from "lucide-react";
import toast, { Toaster } from "react-hot-toast";
import { clsx, type ClassValue } from "clsx";
import { twMerge } from "tailwind-merge";
          ...
          <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                  ...
                  <div>
                    ...
                    <Input 
                      ...
                      value={ageYears} 
                      readOnly 
                      title="Age in years is locked" 
                      className="bg-slate-100/80 text-slate-600 font-medium cursor-not-allowed border-slate-200 focus:ring-0 focus:border-slate-200" 
                      required 
                    />
                  </div>
                  <div>
                  ...
                  <div>
                    <Label>Mother&apos;s Name <span className="text-red-500">*</span></Label>
                    <Input name="motherName" defaultValue={childData.motherName} required placeholder="Enter Mother's Name" />
                  </div>
                  <div>
                    <Label>Father&apos;s Name</Label>
                    <Input name="fatherName" defaultValue={childData.fatherName} placeholder="Enter Father's Name" />
                  </div>
                  <div>
                    <Label>Name of Caretaker / Guardian <span className="text-red-500">*</span></Label>
                    <Input name="parentName" defaultValue={childData.parentName} required placeholder="Enter Caretaker Name" />
                  </div>
                  <div>
                    <Label>Relationship <span className="text-red-500">*</span></Label>
                    <Select name="relationship" value={relationship} onValueChange={setRelationship} required>
            ...
            <Card className="border-0 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.1)]">
              <CardContent className="p-6 sm:p-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                  <div>
                    <Label>Parent Identity Number</Label>
                    <Input name="aadhaarNumber" defaultValue={childData.aadhaarNumber} maxLength={12} pattern="[0-9]{12}" />
                  </div>
                  <div>
                    <Label>BPL Number</Label>
