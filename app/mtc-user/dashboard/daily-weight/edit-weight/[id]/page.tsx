...
//             {/* Bottom Form Actions with Green Save Button */}
//             <div className="flex items-center justify-end gap-3 pt-2">
//               <Button 
//                 variant="outline" 
//                 onClick={() => router.push("/mtc-user/dashboard/daily-weight")} 
//                 className="border-slate-200 text-slate-600 hover:bg-slate-100 rounded-xl px-6 h-11 font-semibold transition-colors"
//               >
//                 <X className="mr-2 h-4 w-4" /> Cancel
//               </Button>
//               <Button 
//                 onClick={handleSave} 
//                 disabled={isSaving} 
//                 className="bg-emerald-600 hover:bg-emerald-700 text-white shadow-lg shadow-emerald-600/25 rounded-xl px-8 h-11 font-semibold transition-all"
//               >
//                 {isSaving ? <Loader2 className="h-5 w-5 mr-2 animate-spin" /> : <Save className="mr-2 h-5 w-5" />}
//                 {isSaving ? "Saving..." : "Save Changes"}
//               </Button>
//             </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-4 space-y-6">
            <Card className="border-slate-200/70 shadow-sm hover:shadow-md transition-shadow duration-300 rounded-2xl overflow-hidden bg-white">
              <CardHeader className="bg-slate-50/50 border-b border-slate-100/80 pb-4">
                <CardTitle className="text-sm font-bold text-slate-500 uppercase tracking-wider flex items-center gap-2">
                  {/* Changed color from blue to violet here */}
                  <User className="h-4 w-4 text-violet-500" /> Patient Profile
                </CardTitle>
              </CardHeader>
              <CardContent className="pt-6">
                <div className="flex items-center gap-4 mb-6">
                  {/* Changed background gradient to violet/fuchsia for distinction */}
                  <div className="h-16 w-16 rounded-full bg-gradient-to-br from-violet-100 to-fuchsia-100 text-violet-700 flex items-center justify-center font-bold text-2xl border-2 border-white shadow-sm shrink-0">
                    {weightData.name.charAt(0)}
                  </div>
                  <div>
                    <h2 className="text-xl font-bold text-slate-900">{weightData.name}</h2>
          ...
          <div className="lg:col-span-8 space-y-6">
            ...
            {/* MOVED: Daily Log is now the first card in the right column */}
            <Card className="border-slate-200/70 shadow-sm hover:shadow-md transition-shadow duration-300 rounded-2xl bg-white">
              <CardHeader className="bg-slate-50/50 border-b border-slate-100/80 pb-4 flex flex-row items-center justify-between">
                <CardTitle className="text-sm font-bold text-slate-500 uppercase tracking-wider flex items-center gap-2">
                  <CalendarDays className="h-4 w-4 text-blue-500" /> Daily Log (kg)
            ...
            {/* MOVED: Growth Trajectory chart is now below the Daily Log */}
            <Card className="border-slate-200/70 shadow-sm hover:shadow-md transition-shadow duration-300 rounded-2xl bg-white">
              <CardHeader className="bg-slate-50/50 border-b border-slate-100/80 pb-4 flex flex-row items-center justify-between">
                <CardTitle className="text-sm font-bold text-slate-500 uppercase tracking-wider flex items-center gap-2">
                  <Activity className="h-4 w-4 text-blue-500" /> Growth Trajectory
