      ...
      <div className="px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              type="button"
              className="relative p-2 rounded-full text-gray-400 hover:bg-gray-100 hover:text-gray-600 focus:outline-none"
            >
            ...
            <button
              type="button"
              className="flex items-center justify-center h-8 w-8 rounded-full bg-indigo-100 text-indigo-700 hover:bg-indigo-200 focus:outline-none transition-colors"
            >
