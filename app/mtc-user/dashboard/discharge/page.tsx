...
// import { Input } from "@/components/ui/input";
// import { Card, CardContent } from "@/components/ui/card";
// import { Search, Home, FileText, Loader2, Users, CheckCircle2, Calendar, Weight, UserCircle } from "lucide-react";
// import toast, { Toaster } from "react-hot-toast";
...
//   return (
//     <div className="min-h-screen bg-slate-50 py-4 sm:py-6 md:py-8 lg:py-10 px-3 sm:px-4 md:px-6 font-sans">
//       <Toaster position="top-center" toastOptions={{ className: 'rounded-xl shadow-lg font-medium' }} />
...
//             </div>
//             <div>
//               <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-slate-900 tracking-tight">Patient Directory</h1>
//               <p className="text-xs sm:text-sm text-slate-500 font-medium mt-0.5">Manage and discharge admitted children</p>
//             </div>
//           </div>
//           <Button onClick={handleBackToHome} variant="outline" className="w-full sm:w-auto border-slate-200 text-slate-700 hover:bg-slate-100 hover:text-blue-700 transition-colors bg-white shadow-sm">
//             <Home className="mr-2 h-4 w-4" /> Back to Home
//           </Button>
//         </div>
...
//               <div>
//                 <label className="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2">From Date</label>
//                 <Input type="date" value={fromDate} onChange={(e) => setFromDate(e.target.value)} className="bg-slate-50 focus-visible:ring-blue-500 h-11" />
//               </div>

//               <div>
//                 <label className="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2">To Date</label>
//                 <Input type="date" value={toDate} onChange={(e) => setToDate(e.target.value)} className="bg-slate-50 focus-visible:ring-blue-500 h-11" />
//               </div>

//               <div>
//                 <label className="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2">Record No</label>
//                 <Input placeholder="Search Record..." value={recordNo} onChange={(e) => setRecordNo(e.target.value)} className="bg-slate-50 focus-visible:ring-blue-500 h-11" />
//               </div>

//               <div>
//                 <label className="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2">SAM Number</label>
//                 <Input placeholder="Search SAM..." value={samNumber} onChange={(e) => setSamNumber(e.target.value)} className="bg-slate-50 focus-visible:ring-blue-500 h-11" />
//               </div>

//               <div>
//                 <label className="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2">Child Name</label>
//                 <div className="flex gap-2">
//                   <Input placeholder="Search Name..." value={childName} onChange={(e) => setChildName(e.target.value)} className="bg-slate-50 focus-visible:ring-blue-500 h-11" />
//                   <Button onClick={handleSearch} className="bg-blue-600 hover:bg-blue-700 px-4 h-11 shadow-sm shrink-0">
//                     <Search className="w-4 h-4" />
//                   </Button>
//                 </div>
//               </div>
...
//         {/* View Tabs - Scrollable horizontally on small phones */}
//         <div className="overflow-x-auto custom-scrollbar pb-2 sm:pb-0">
//           <div className="flex gap-2 items-center bg-white p-1.5 rounded-xl border border-slate-200 shadow-sm min-w-max w-fit">
//             <button
//               onClick={() => setViewType("all")}
//               className={`px-4 py-2 text-sm font-semibold rounded-lg transition-all whitespace-nowrap ${viewType === "all" ? "bg-slate-800 text-white shadow" : "text-slate-600 hover:bg-slate-100"}`}
//             >
//               All Patients <span className="ml-1 text-xs opacity-70">({countAll})</span>
//             </button>
//             <button
//               onClick={() => setViewType("normal")}
//               className={`px-4 py-2 text-sm font-semibold rounded-lg transition-all whitespace-nowrap ${viewType === "normal" ? "bg-blue-600 text-white shadow" : "text-slate-600 hover:bg-slate-100"}`}
//             >
//               Normal Reg <span className="ml-1 text-xs opacity-70">({countNormal})</span>
//             </button>
//             <button
//               onClick={() => setViewType("samar")}
//               className={`px-4 py-2 text-sm font-semibold rounded-lg transition-all flex items-center gap-2 whitespace-nowrap ${viewType === "samar" ? "bg-purple-600 text-white shadow" : "text-slate-600 hover:bg-slate-100"}`}
//             >
//               <CheckCircle2 className="w-4 h-4" />
//               SAAMAR Tracker <span className="ml-0.5 text-xs opacity-70">({countSamar})</span>
//             </button>
...
//         {/* --- Main Content Area (Responsive Handle) --- */}
//         {isLoading ? (
//           <div className="py-20 text-center bg-white rounded-xl shadow-sm border border-slate-100">
//             <Loader2 className="h-10 w-10 animate-spin text-blue-600 mx-auto mb-4" />
//             <p className="text-slate-500 font-medium text-lg">Fetching patient records...</p>
//           </div>
//         ) : filteredData.length === 0 ? (
//           <div className="py-20 text-center bg-white rounded-xl shadow-sm border border-slate-100">
...
//             </div>
//             <p className="font-bold text-slate-700 text-xl">No records found</p>
//             <p className="mt-2 text-slate-500">Adjust your filters or register a new child.</p>
//           </div>
//         ) : (
//           <>
//             {/* VIEW 1: MOBILE & TABLET (Cards View) */}
//             <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:hidden">
//               {filteredData.map((child) => (
//                 <Card key={child.id} className="border border-slate-200 shadow-sm hover:shadow-md transition-shadow">
...
//                           Record: <span className="text-slate-700">{child.recordNo}</span> • SAM: <span className="text-slate-700">{child.samNumber}</span>
//                         </p>
//                       </div>
...
//                           <span className="inline-flex items-center px-2 py-0.5 rounded text-[10px] font-bold tracking-widest uppercase bg-purple-100 text-purple-700 border border-purple-200">
//                             SAAMAR
//                           </span>
//                         </div>
//                       ) : (
//                         <span className="inline-flex items-center px-2 py-0.5 rounded text-[10px] font-bold tracking-widest uppercase bg-slate-100 text-slate-500 border border-slate-200">
//                           Normal
//                         </span>
//                       )}
//                     </div>
...
//                         <div>
//                           <p className="text-[11px] font-semibold text-slate-400 uppercase">Admission</p>
//                           <p className="font-medium text-slate-800">{child.admissionDate}</p>
//                         </div>
//                       </div>
//                       <div className="flex items-start gap-2 text-slate-600">
//                         <Weight className="w-4 h-4 mt-0.5 text-slate-400 shrink-0" />
//                         <div>
//                           <p className="text-[11px] font-semibold text-slate-400 uppercase">Weight</p>
//                           <p className="font-medium text-slate-800">{child.admissionWeight} <span className="text-xs text-slate-500">kg</span></p>
//                         </div>
//                       </div>
...
//                         <div>
//                           <p className="text-[11px] font-semibold text-slate-400 uppercase">Parent/Guardian</p>
...
//                       <Button 
//                         onClick={() => handleDischarge(child.id)} 
//                         className="w-full bg-emerald-50 text-emerald-700 hover:bg-emerald-600 hover:text-white border border-emerald-200 transition-colors font-semibold"
//                       >
//                         <FileText className="w-4 h-4 mr-2" />
//                         Discharge Patient
//                       </Button>
...
//             <Card className="hidden lg:block border-0 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.1)] overflow-hidden">
...
//                       <th className="py-4 px-6 text-left font-bold">Child Name</th>
//                       <th className="py-4 px-6 text-left font-bold">Registration Type</th> 
//                       <th className="py-4 px-6 text-left font-bold">Parent Name</th>
//                       <th className="py-4 px-6 text-left font-bold">Weight (kg)</th>
//                       <th className="py-4 px-6 text-center font-bold">Actions</th>
//                     </tr>
//                   </thead>
//                   <tbody className="divide-y divide-slate-100">
...
//                       <tr key={child.id} className="hover:bg-blue-50/50 transition-colors bg-white">
//                         <td className="py-4 px-6 font-semibold text-slate-700">{child.recordNo}</td>
//                         <td className="py-4 px-6 text-slate-600 font-medium">{child.samNumber}</td>
//                         <td className="py-4 px-6 text-slate-600">{child.admissionDate}</td>
//                         <td className="py-4 px-6 font-bold text-slate-900">{child.childName}</td>
//                         <td className="py-4 px-6">
//                           {child.isSamarRegistered ? (
...
//                           )}
//                         </td>
//                         <td className="py-4 px-6 text-slate-600">{child.parentName}</td>
//                         <td className="py-4 px-6 text-slate-600">{child.admissionWeight}</td>
//                         <td className="py-4 px-6">
//                           <div className="flex justify-center gap-2">
//                             <Button 
//                               onClick={() => handleDischarge(child.id)} 
//                               className="bg-emerald-50 text-emerald-700 hover:bg-emerald-600 hover:text-white px-4 py-2 h-auto rounded-lg shadow-none border border-emerald-200 hover:border-emerald-600 transition-all font-medium" 
...
import { Input } from "@/components/ui/input";
import { Card, CardContent } from "@/components/ui/card";
import { Search, Home, FileText, Loader2, Users, CheckCircle2, Calendar, Weight, UserCircle, Filter, X } from "lucide-react";
import toast, { Toaster } from "react-hot-toast";
...
export default function DischargeDirectoryPage() {
  ...
  const hasActiveFilters = recordNo || samNumber || fromDate || toDate || childName;
    ...
    <div className="min-h-screen bg-slate-50 py-4 sm:py-6 md:py-8 lg:py-10 px-3 sm:px-4 md:px-6 font-sans">
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          ...
          <Button onClick={handleBackToHome} variant="outline" className="w-full sm:w-auto border-slate-200 text-slate-700 hover:bg-slate-100 hover:text-blue-700 transition-colors bg-white shadow-sm rounded-xl">
            <Home className="mr-2 h-4 w-4" /> Back to Home
          </Button>
        </div>
        ...
        <Card className="border border-slate-200 shadow-sm bg-white overflow-hidden rounded-xl">
          <CardContent className="p-0">
            ...
            <div className="p-4 border-b border-slate-100 flex flex-col sm:flex-row gap-3 items-center bg-slate-50/50">
              <div className="relative flex-1 w-full">
                ...
                <Input 
                  ...
                  value={childName} 
                  onChange={(e) => setChildName(e.target.value)} 
                  className="pl-10 h-11 bg-white border-slate-200 focus-visible:ring-blue-500 shadow-sm rounded-xl text-md" 
                />
              </div>
              <div className="flex gap-2 w-full sm:w-auto">
                <Button 
                  ...
                  className={`h-11 rounded-xl shadow-sm flex-1 sm:flex-none transition-all ${showFilters ? 'bg-blue-50 text-blue-700 border-blue-200 hover:bg-blue-100' : 'bg-white text-slate-700 border-slate-200'}`}
                >
                  <Filter className="w-4 h-4 mr-2" />
                  {showFilters ? 'Hide Filters' : 'Advanced Filters'}
                  {(recordNo || samNumber || fromDate || toDate) && !showFilters && (
                ...
                {hasActiveFilters && (
                  <Button 
                    ...
                    variant="ghost" 
                    className="h-11 rounded-xl text-slate-500 hover:text-red-600 hover:bg-red-50 flex-1 sm:flex-none"
                  >
            ...
            {showFilters && (
              <div className="p-5 bg-white grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 animate-in slide-in-from-top-2 duration-200">
                <div className="space-y-1.5">
                  <label className="text-[11px] font-bold text-slate-500 uppercase tracking-wider flex items-center gap-1.5">
                    <Calendar className="w-3.5 h-3.5" /> From Date
                  </label>
                  <Input type="date" value={fromDate} onChange={(e) => setFromDate(e.target.value)} className="bg-slate-50 focus-visible:ring-blue-500 h-10 rounded-lg" />
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <Input type="date" value={toDate} onChange={(e) => setToDate(e.target.value)} className="bg-slate-50 focus-visible:ring-blue-500 h-10 rounded-lg" />
                </div>

                <div className="space-y-1.5">
                  <label className="text-[11px] font-bold text-slate-500 uppercase tracking-wider flex items-center gap-1.5">
                    <FileText className="w-3.5 h-3.5" /> Record No
                  </label>
                  <Input placeholder="Enter Record No" value={recordNo} onChange={(e) => setRecordNo(e.target.value)} className="bg-slate-50 focus-visible:ring-blue-500 h-10 rounded-lg" />
                </div>

                <div className="space-y-1.5">
                  <label className="text-[11px] font-bold text-slate-500 uppercase tracking-wider flex items-center gap-1.5">
                    <Users className="w-3.5 h-3.5" /> SAM Number
                  </label>
                  <Input placeholder="Enter SAM Number" value={samNumber} onChange={(e) => setSamNumber(e.target.value)} className="bg-slate-50 focus-visible:ring-blue-500 h-10 rounded-lg" />
                </div>
              </div>
            )}
          </CardContent>
        ...
        {isLoading ? (
          ...
          <div className="py-20 text-center bg-white rounded-xl shadow-sm border border-slate-100">
            ...
            <p className="mt-2 text-slate-500">Adjust your filters or register a new child.</p>
            {hasActiveFilters && (
              <Button onClick={clearFilters} variant="outline" className="mt-4 text-blue-600 border-blue-200 hover:bg-blue-50">
                Clear all filters
              </Button>
            )}
          </div>
          ...
          <>
            ...
            {/* VIEW 2: DESKTOP (Table View) */}
            <Card className="hidden lg:block border-0 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.1)] overflow-hidden rounded-xl">
              <div className="overflow-x-auto">
                <table className="min-w-full text-sm text-slate-700 border-collapse">
                  <thead>
                    <tr className="bg-slate-50 border-b border-slate-200 text-slate-500 uppercase text-xs tracking-wider">
