...
//   MTCCode: string;
//   LastUpdated?: string | Date;
//   [key: string]: number | string | Date | undefined; // Flexible index signature for mapping
// }
...
//     let query = '';
//     if (exists) {
//        query = `UPDATE [MTCJharkhand].[dbo].[MTCFollowUp] SET ...` // Shortened for brevity, use your logic or full update string
//        // Note: Since this is identical to your provided file, I assume the update string logic is fine. 
//        // I'll ensure the delete function is present below.
...
// // ==========================================
// // 9. DELETE FUNCTION (Added)
// // ==========================================

// export async function deleteChild(samNo: string) {
//   try {
//     const db = await getDBConnection();
//     // Safety: Deletes the main child record. 
//     // Ideally, you should also delete from DailyWeight, FollowUp, etc. 
//     // Example:
//     // await db.request().input('SamNo', sql.NVarChar, samNo).query(`DELETE FROM [MTCJharkhand].[dbo].[MTCSAMDailyWeight] WHERE SamNo = @SamNo`);
...
// // lib/db.ts - Append these functions

// // ... existing imports and setup ...

// // 1. Fetch simplified child data for the Edit Form
...
// // 2. Update the Child Record
// export async function updateChildRegistration(samNo: string, data: any) {
//   try {
//     const db = await getDBConnection();
//     const request = db.request();
...
//     request.input('FatherName', sql.NVarChar, data.parentName); // Assuming ParentName maps to FatherName or MotherName based on relationship
//     request.input('MotherName', sql.NVarChar, data.relationship === '2' ? data.parentName : null); // Simple logic, adjust as needed
...
//     request.input('BlockId', sql.Int, parseInt(data.block) || null);
//     request.input('ICDSId', sql.Int, parseInt(data.icdsProject) || null);
//     request.input('AnganwadiId', sql.Int, parseInt(data.anganwadiCenter) || null);
//     request.input('VillageName', sql.NVarChar, data.village);
//     request.input('AdmissionDate', sql.DateTime, new Date(data.admissionDate)); // Time is usually combined here
